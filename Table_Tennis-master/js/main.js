/*
	Changes made by Hunter Paulsen
	5/21/2023
*/
window.onload = function () {
	...
	zuruck.volume = 0.5;
	var fail = new Audio();
	// Exchanged fail.mp3 with ScoreBlip.mp3. The buzzer was too annoying to listen to while testing.
	fail.src = "ScoreBlip.mp3";
	fail.volume = 0.2;
	// Added a background music variable to liven things up
	var BGM = new Audio();
	BGM.src = "BGM.mp3";
	BGM.volume = 0.1;
	...
	function losSpiel() {
		...
		// Added a play and loop metheod for the background music
		BGM.play();
		BGM.loop = true;
		bewegung();
	}
	...
	function erzeugAlle() {
		...
		// Added numbers to the scores to better differentiate who is who
		cxt.fillText("Score 1 : "+spieler1Punkt,leerPlatzMarginX/4,leerPlatz/2);
		cxt.fillText("Score 2 : "+spieler2Punkt,canvas.width-(leerPlatzMarginX),leerPlatz/2);
	}
